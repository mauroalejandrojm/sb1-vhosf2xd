        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed max-w-3xl mb-10">
              ...
              My expertise spans across diverse industries including logistics, psychology, robotics, and education, where I've helped organizations and individuals harness the power of their data.
            </p>
            <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed max-w-3xl">
              I enjoy solving complex data challenges and building scalable infrastructure that enables data-driven decision making. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div 
                key={index}
                className="p-6 rounded-lg border border-slate-200 dark:border-slate-800 hover:border-blue-600 dark:hover:border-blue-400 transition-colors duration-300"
              >
