        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <div className="space-y-6 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
              <p>
                I'm a Senior Data Engineer with over 7 years of experience designing, implementing, managing, and optimizing data pipelines and analytics platforms. My expertise spans logistics, psychology, robotics, quantum physics and education — where I've helped organizations harness the knowledge locked in their data.
              </p>
              <p>
