...
const Skills: React.FC = () => {
  ...
  const processes: Process[] = [
    ...
    },
    {
      ...
      description: "Engineer clean, modular pipelines with strong data quality checks, testing, and observability. Focus on automation and CI/CD integration.",
      skills: [
        "ETL/ELT Development",
        "Python/SQL",
            ...
            {processes.map((process, index) => (
              <div key={index} className="relative">
                ...
                {index < processes.length - 1 && (
                  <div className="absolute left-7 top-20 bottom-0 w-0.5 bg-blue-200 dark:bg-blue-900 -z-10"></div>
                )}
                ...
                >
                  ...
                  <div className={`overflow-hidden transition-all duration-300 ${
                    activePhase === index ? 'max-h-96' : 'max-h-0'
                  }`}>
